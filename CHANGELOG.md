# BlockShips Changelog: v0.0.10 to HEAD
...
- Validates player is riding a ship shulker before dismounting
- Properly frees the seat in the ship instance
...
| Category | Files |
|----------|-------|
| Core Ship | ShipInstance.java, ShipPhysics.java, ShipCollision.java |
| Steering | ShipSteeringListener.java |
| Display | DisplayShip.java |
| Persistence | ShipWorldData.java |
| Compatibility | AttributeCompat.java, ServerVersion.java, SteerPacketCompat.java, TeleportCompat.java |
| Plugin | BlockShipsPlugin.java, plugin.yml, config.yml |
| Test Bot | test-bot.js, chunk-test.js, lib/helpers.js, package.json |
| CI/CD | checks.yml, server-test.yml, Makefile |
